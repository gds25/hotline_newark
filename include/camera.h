 ...
 */
SDL_Rect camera_get_rectangle();

/**
 * @brief returns the position (offset) of the world objects for things to be drawn relative to the camera
 * @return the inverse of the camera coordinates
 */
Vector2D world_get_offset();
#endif
