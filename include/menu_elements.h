#ifndef __MENU_ELEMENTS_H__
#define __MENU_ELEMENTS_H__

#include "simple_json.h"
#include "gfc_types.h"
#include "simple_json_config.h"
/**
 * @purpose elements are window elements like labels, buttons, status bars, etc
...
typedef struct Element_S
{
    ...
    SDL_Rect bounds;    /**<drawing bounds for the element*/
    ...
    List* (*update)     (struct Element_S* element, Vector2D offset); /**<function called for updates  returns a list of all elements updated with input*/
 ...
 */
void menu_element_free(Element* element);
 ...
 */
void menu_element_draw(Element* element, Vector2D offset);
 ...
 */
List* menu_element_update(Element* element, Vector2D offset);
