...
SDL_Rect gf2d_font_get_text_wrap_bounds_tag(
    char* thetext,
    FontTypes   tag,
    Uint32      w,
    Uint32      h
...
SDL_Rect gf2d_font_get_text_wrap_bounds(
    char* thetext,
    Font* font,
    Uint32   w,
    Uint32   h
...
void gf2d_font_draw_text_wrap_tag(char* text, FontTypes tag, Color color, SDL_Rect block)
{
