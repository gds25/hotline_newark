...
int sj_value_as_vector2d(SJson* json, Vector2D* output)
{
    ...
    if (sj_is_array(json))
    {
        ...
        if (output)
        {
            output->x = numbers[0];
            output->y = numbers[1];
            //Vector2D final = vector2d(output->x, output->y);
            return 1;
        }
    }
...
int sj_value_as_vector3d(SJson* json, Vector3D* output)
{
    ...
    if (sj_is_array(json))
    {
        ...
        //Vector3D final = vector3d(output->x, output->y, output->z);
        return 1;
    }
    if (sj_is_string(json))
    {
...
int sj_value_as_vector4d(SJson* json, Vector4D* output)
{
    ...
    if (sj_is_array(json))
    {
        ...
        //Vector4D final = vector4d(output->x, output->y, output->z, output->w);
        return 1;
    }
    if (sj_is_string(json))
    {
